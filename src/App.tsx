...
const Win7Folder = ({
  ...
  >
    ...
    <path
      d="M4 12C4 10.34 5.34 9 7 9H18L22 13H41C42.66 13 44 14.34 44 16V38C44 39.66 42.66 41 41 41H7C5.34 41 4 39.66 4 38V12Z"
      fill="url(#folderBack)"
      stroke="#92400e"
      strokeWidth="0.5"
    />
    <path
      d="M4 17C4 15.34 5.34 14 7 14H41C42.66 14 44 15.34 44 17V38C44 39.66 42.66 41 41 41H7C5.34 41 4 39.66 4 38V17Z"
...
const Win7Document = ({
  ...
  >
    ...
    />
    <path
      d="M30 4L40 14H31.5C30.67 14 30 13.33 30 12.5V4Z"
      fill="#F3F4F6"
      stroke="#d1d5db"
      strokeWidth="0.5"
    />
    ...
    {variant === "skills" && (
      <g transform="translate(18, 26)">
        ...
        {/* Star */}
        <path
          d="M22 -10 L24 -4 L30 -4 L25 0 L27 6 L22 2 L17 6 L19 0 L14 -4 L20 -4 Z"
          fill="#FBBF24"
          stroke="#D97706"
          strokeWidth="0.5"
...
const Win7Paint = ({ size = 48 }: { size?: number }) => (
  ...
  >
    ...
    <path
      d="M10 24C10 32 16 38 24 38C32 38 38 32 38 24C38 16 32 10 24 10C20 10 16 12 14 14C12 16 10 20 10 24Z"
    ...
    {/* Brushes */}
    <path
      d="M36 12L44 4L47 7L39 15L36 12Z"
      fill="#4b5563"
      stroke="#1f2937"
      strokeWidth="0.5"
    />
...
const Win7Phone = ({ size = 48 }: { size?: number }) => (
  ...
  >
    ...
    {/* Base of the phone */}
    <path
      d="M14 22 C14 18 18 16 24 16 C30 16 34 18 34 22 L34 34 C34 38 30 40 24 40 C18 40 14 38 14 34 Z"
      fill="url(#phoneBodyGrad)"
      filter="url(#phoneShadow)"
    />
    {/* Handset Top */}
    <path
      d="M12 10 C12 7 16 6 24 6 C32 6 36 7 36 10 L36 14 C36 16 34 18 32 18 L16 18 C14 18 12 16 12 14 Z"
      fill="url(#phoneBodyGrad)"
      stroke="#064e3b"
      strokeWidth="0.5"
    />
    ...
    {/* Coiled Cord */}
    <path
      d="M14 34 Q 10 34 8 38 Q 6 42 10 44 Q 14 46 18 42"
      stroke="#059669"
      strokeWidth="1.5"
      fill="none"
      strokeDasharray="1 2"
    ...
    {/* Gloss Reflection */}
    <path
      d="M14 10 L34 10 Q 30 7 24 7 Q 18 7 14 10"
      fill="white"
      fillOpacity="0.2"
    />
  </svg>
...
const Win7RecycleBin = ({
  ...
  >
    ...
    {/* Mesh body */}
    <path
      d="M12 12 L16 42 L32 42 L36 12 Z"
...
const Win7ZipIcon = ({ size = 48 }: { size?: number }) => (
  ...
  >
    ...
    {/* Shadow */}
    <path
      d="M6 14 L18 14 L22 18 L42 18 V40 H6 Z"
      fill="black"
      fillOpacity="0.1"
    ...
    {/* Main Folder Body */}
    <path
      d="M6 14 C6 12.34 7.34 11 9 11 H18 L22 15 H41 C42.66 15 44 16.34 44 18 V38 C44 39.66 42.66 41 41 41 H9 C7.34 41 6 39.66 6 38 V14Z"
      fill="url(#zipFolderGrad)"
      stroke="#92400e"
      strokeWidth="0.5"
    />
    <path
      d="M6 20 C6 18.34 7.34 17 9 17 H41 C42.66 17 44 18.34 44 20 V38 C44 39.66 42.66 41 41 41 H9 C7.34 41 6 39.66 6 38 V20Z"
      fill="#ffe08a"
      stroke="#b45309"
      strokeWidth="0.5"
    />
...
const Win7RunIcon = ({ size = 48 }: { size?: number }) => (
  ...
  >
    ...
    <path
      d="M14 22 L20 22 L20 25 L24 21 L20 17 L20 20 L14 20 Z"
      fill="#3b82f6"
    />
    ...
    const handleMouseMove = (e: MouseEvent) => {
      if (isDragging) {
        ...
        const clampedX = Math.max(
          -600,
          Math.min(window.innerWidth - 40, nextX),
        );
        ...
        >
          ...
          >
            <div className="flex items-center gap-2">
              <Icon size={18} />
              <span className="text-white text-[13px] font-medium drop-shadow-sm font-sans">
                {title}
              </span>
            </div>
            <div className="flex items-center gap-0.5">
              ...
              >
                <Minus
                  size={16}
                  className="text-white transition-opacity group-hover:opacity-100 opacity-80"
                />
              </div>
              <div
                onClick={(e) => {
              ...
              >
                <X
                  size={18}
                  className="text-white transition-transform group-hover:rotate-90 duration-300"
                />
              </div>
            </div>
          </div>
...
const desktopIcons = [
  ...
  { id: 2, name: "M.Taibe's Projects", component: Win7Folder },
  {
    id: 3,
    name: "Private Files",
    component: (props: any) => <Win7Folder {...props} restricted />,
  },
  { id: 4, name: "My Resume", component: Win7Document },
  {
    id: 5,
    name: "M.Taibe's Skills",
    component: (props: any) => <Win7Document {...props} variant="skills" />,
  },
...
export default function App() {
  const [computerPath, setComputerPath] = useState<string[]>(["Computer"]);
  ...
  const computerImages = [
    {
      name: "Photo 1.jpg",
      url: "https://i.pinimg.com/736x/88/cb/ca/88cbca8b58538faaff9f3e7f653eb123.jpg",
    },
    {
      name: "Photo 2.jpg",
      url: "https://i.pinimg.com/736x/a5/19/52/a51952b60084d169d7a1b51efd18c5d4.jpg",
    },
    {
      name: "Photo 3.jpg",
      url: "https://i.pinimg.com/736x/e8/ae/b8/e8aeb83ac15b75dac0603e6eba5e4cfc.jpg",
    },
    {
      name: "Photo 4.jpg",
      url: "https://i.pinimg.com/736x/af/4d/a5/af4da5dd0b6e4f8b84928fa7d15b41ca.jpg",
    },
    {
      name: "Photo 5.jpg",
      url: "https://i.pinimg.com/736x/a9/af/01/a9af01dcacf31df0d3434639732ce417.jpg",
    },
    {
      name: "Photo 6.jpg",
      url: "https://i.pinimg.com/736x/74/ff/32/74ff32d3f458b82c1c472a115f8f290e.jpg",
    },
    {
      name: "Photo 7.jpg",
      url: "https://i.pinimg.com/736x/14/35/95/143595c52d4b36cd5f4e13c890aaab2d.jpg",
    },
    {
      name: "Photo 8.jpg",
      url: "https://i.pinimg.com/736x/39/7b/3f/397b3f2b5ebe18261fa51a56ec6a6b6b.jpg",
    },
    {
      name: "Photo 9.jpg",
      url: "https://i.pinimg.com/736x/87/0d/ef/870def0e4bc5c6cf11341ba871dc78df.jpg",
    },
    {
      name: "Photo 10.jpg",
      url: "https://i.pinimg.com/736x/d2/c1/40/d2c1403e05fe858535dc8072839bd871.jpg",
    },
    {
      name: "Photo 11.jpg",
      url: "https://i.pinimg.com/736x/b7/35/29/b735298bcdca8a8e2f03867f3dd9ee63.jpg",
    },
    {
      name: "Photo 12.jpg",
      url: "https://i.pinimg.com/736x/58/6c/cd/586ccd7185c9c17d61d298e00c6fc66d.jpg",
    },
  ];
  ...
  const [recycleFiles, setRecycleFiles] = useState([
    ...
    {
      name: "React_Framework_Boilerplate.js",
      icon: Win7CodeDocIcon,
      color: "",
    },
  ...
  const [wallpaper, setWallpaper] = useState(
    "https://i.pinimg.com/1200x/da/28/8d/da288dceaafd7c97f1b09c594eac7868.jpg",
  );
  const [isPersonalizeOpen, setIsPersonalizeOpen] = useState(false);
  const [isResolutionOpen, setIsResolutionOpen] = useState(false);
  const [isGadgetsOpen, setIsGadgetsOpen] = useState(false);
  ...
  const wallpapers = [
    {
      name: "Dark Aesthetic",
      url: "https://i.pinimg.com/1200x/da/28/8d/da288dceaafd7c97f1b09c594eac7868.jpg",
    },
    {
      name: "Windows 7 Legacy",
      url: "https://images.wallpapersden.com/image/download/windows-7-official-hd_a21ubmeUmZqaraWkpJRmbmdlrWZlbWU.jpg",
    },
    {
      name: "Scenic View",
      url: "https://i.pinimg.com/1200x/54/aa/9d/54aa9d05ac9be7c4bcb9572670c67683.jpg",
    },
    {
      name: "Mountain Peak",
      url: "https://i.pinimg.com/736x/fe/c3/db/fec3db297d630dbcec7a984a3cb7acbf.jpg",
    },
    {
      name: "Modern Abstract",
      url: "https://i.pinimg.com/736x/32/85/90/3285908580d255634267555bae2d61a8.jpg",
    },
    {
      name: "Forest Path",
      url: "https://i.pinimg.com/736x/56/ae/7f/56ae7f613917b3b214c1bd0c5a1585ae.jpg",
    },
    {
      name: "Ocean Mist",
      url: "https://i.pinimg.com/736x/cf/44/40/cf44402fef0094274b7347e4b6cfd33d.jpg",
    },
  ];
    ...
    if (file) {
      setDesktopIcons((prev) => [
        ...prev,
        {
          ...file,
          id:
            (file as any).originalId || Math.max(...prev.map((i) => i.id)) + 1,
        },
      ]);
  ...
  const handleRecycleItemDragEnd = (
    event: any,
    info: any,
    fileIndex: number,
  ) => {
  ...
  const handleTerminalFileDragEnd = (
    event: any,
    info: any,
    fileName: string,
  ) => {
  ...
  const startDrawing = (e: React.MouseEvent) => {
    ...
    if (ctx) {
      ...
      ctx.lineWidth =
        paintTool === "eraser" ? paintBrushSize * 4 : paintBrushSize;
      ctx.lineCap = "round";
      ctx.lineJoin = "round";
      ctx.lineTo(x, y);
      ctx.stroke();
  ...
  useEffect(() => {
    if (
      ...
      windows.terminal.zIndex === topZIndex
    ) {
  ...
  const handleNotepadFindNext = () => {
    ...
    const index = text
      .toLowerCase()
      .indexOf(notepadSearchQuery.toLowerCase(), start);
    ...
    if (index !== -1) {
      ...
      // Wrap around
      const wrapIndex = text
        .toLowerCase()
        .indexOf(notepadSearchQuery.toLowerCase());
      if (wrapIndex !== -1) {
        textarea.focus();
        textarea.setSelectionRange(
          wrapIndex,
          wrapIndex + notepadSearchQuery.length,
        );
      }
    }
  };
  ...
  const handleNotepadReplace = () => {
    ...
    if (selectedText.toLowerCase() === notepadSearchQuery.toLowerCase()) {
      const newText =
        notepadText.substring(0, start) +
        notepadReplaceQuery +
        notepadText.substring(end);
  ...
  const handleNotepadReplaceAll = () => {
    ...
    const escapedQuery = notepadSearchQuery.replace(
      /[.*+?^${}()|[\]\\]/g,
      "\\$&",
    );
  ...
  const handleNotepadAction = (action: string) => {
    ...
    switch (action) {
      ...
      case "wordWrap":
        ...
        break;
      case "fontSmall":
        setNotepadFontSize("11px");
        break;
      case "fontMedium":
        setNotepadFontSize("14px");
        break;
      case "fontLarge":
        setNotepadFontSize("18px");
        break;
      case "find":
  ...
  useEffect(() => {
    ...
    const SOUND_BASE_URL =
      "https://raw.githubusercontent.com/Anis-Mowen/Windows-Default-Sounds/master/";
    ...
    clickSound.current = new Audio(
      `${SOUND_BASE_URL}Windows%20Navigation%20Start.wav`,
    );
    ...
    minimizeSound.current = new Audio(
      `${SOUND_BASE_URL}Windows%20Minimize.wav`,
    );
  ...
  return (
    <div
      className={`relative h-screen w-screen overflow-hidden font-sans text-white transition-all duration-1000 select-none ${isLoggingIn ? "cursor-wait" : ""}`}
    >
        ...
        {!isLoggedIn ? (
          ...
          >
            ...
            <motion.div
              ...
              style={{
                backgroundImage: `url('https://images4.alphacoders.com/264/264746.jpg')`,
              }}
            />
            ...
            {/* Unified Overlay */}
            <div
              className={`absolute inset-0 transition-all duration-1000 ${isDarkTheme ? "bg-black/30 backdrop-blur-[40px]" : "bg-blue-600/10 backdrop-blur-[4px]"}`}
            />
            ...
            >
              <div className="bg-white/[0.03] backdrop-blur-[12px] rounded-xl p-1.5 border border-white/10 flex items-center gap-1">
                ...
                >
                  ...
                  <span className="text-[10px] font-light tracking-[0.15em] text-white uppercase">
                    M.Taibe
                  </span>
                </button>
                <button
          ...
          >
            ...
            <div
              ref={desktopRef}
              className="relative z-10 h-full w-full p-4 flex flex-col"
            >
              ...
              >
                {sortedIcons.map((icon) => (
                  ...
                  >
                    <div
                      className={`mb-2 drop-shadow-md group-hover:drop-shadow-lg transition-transform
                    ...
                    <span
                      className={`text-white text-center leading-tight icon-text-shadow font-normal px-1 w-full line-clamp-2 break-words
              ...
              <OSWindow
                ...
                height="480px"
                onClose={() => {
                  closeWindow("myComputer");
                  setComputerPath(["Computer"]);
                }}
              ...
              >
                <div className="flex-1 bg-white flex flex-col select-none">
                  <div className="h-10 border-b border-slate-300 flex items-center justify-between px-3">
                    <div className="flex items-center gap-4 text-xs font-medium text-slate-700 h-full w-full">
                      <div className="flex items-center gap-1 h-full">
                        <button
                          disabled={computerPath.length <= 1}
                          onClick={() =>
                            setComputerPath((prev) => prev.slice(0, -1))
                          }
                          className="p-1 hover:bg-gray-100 rounded disabled:opacity-30 disabled:hover:bg-transparent transition-colors"
                        >
                          <ArrowLeft size={16} />
                        </button>
                        <button className="p-1 hover:bg-gray-100 rounded opacity-30 cursor-not-allowed">
                          <ArrowRight size={16} />
                        </button>
                      </div>
                      <div className="flex items-center gap-1 text-[11px] bg-white border border-gray-300 px-2 py-0.5 rounded flex-1 min-w-[200px]">
                        {computerPath.map((part, i) => (
                  ...
                  <div className="h-8 bg-gradient-to-b from-[#fdfdfd] to-[#eff2f7] border-b border-gray-300 flex items-center px-2 gap-2 text-[11px] text-gray-700">
                    <div className="hover:bg-[#e5f3ff] hover:outline hover:outline-1 hover:outline-[#70c0ff] px-3 py-1 rounded cursor-default active:bg-[#cce8ff]">
                      Organize
                    </div>
                    <div className="w-[1px] h-4 bg-gray-300 mx-1" />
                    {computerPath[computerPath.length - 1] === "Computer" ? (
                      <>
                        <div className="hover:bg-[#e5f3ff] hover:outline hover:outline-1 hover:outline-[#70c0ff] px-3 py-1 rounded cursor-default">
                          System properties
                        </div>
                        <div className="hover:bg-[#e5f3ff] hover:outline hover:outline-1 hover:outline-[#70c0ff] px-3 py-1 rounded cursor-default">
                  ...
                  <div className="flex-1 flex overflow-hidden select-none">
                    {/* Navigation Pane */}
                    <div className="w-44 bg-[#f9f9f9] border-r border-gray-300 flex flex-col p-2 text-[11px] text-gray-700">
                      <div className="flex items-center gap-2 p-1 hover:bg-[#e5f3ff] rounded cursor-default">
                        <ChevronRight size={12} className="text-gray-400" />
                        <FolderLock size={14} className="text-blue-500" />
                        <span>Favorites</span>
                      </div>
                      <div className="flex items-center gap-2 p-1 hover:bg-[#e5f3ff] rounded cursor-default mt-2">
                        <ChevronRight
                          size={12}
                      ...
                      <div className="ml-6 flex flex-col gap-0.5 mt-1 border-l border-gray-200">
                        <div
                          className={`flex items-center gap-2 p-1 pl-3 hover:bg-[#e5f3ff] rounded cursor-default ${computerPath[computerPath.length - 1] === "Local Disk (C:)" ? "bg-[#e5f3ff] outline outline-1 outline-[#70c0ff]" : ""}`}
                          onClick={() =>
                            setComputerPath(["Computer", "Local Disk (C:)"])
                          }
                        >
                          <Win7Computer size={14} />
                          <span>Local Disk (C:)</span>
                        </div>
                        <div className="flex items-center gap-2 p-1 pl-3 hover:bg-[#e5f3ff] rounded cursor-default opacity-50">
                          <Archive size={14} />
                          <span>Recovery (D:)</span>
                        </div>
                      </div>
                      <div className="flex items-center gap-2 p-1 hover:bg-[#e5f3ff] rounded cursor-default mt-2">
                    ...
                    {/* Main Content Area */}
                    <div className="flex-1 p-6 bg-white overflow-y-auto font-sans shadow-[inset_1px_1px_4px_rgba(0,0,0,0.05)]">
                    {computerPath[computerPath.length - 1] === "Computer" ? (
                      <div className="mb-8">
                        <h3 className="text-xs font-semibold text-blue-800 border-b border-blue-200 pb-1 mb-4">
                          Hard Disk Drives (1)
                        </h3>
                        <div
                          onClick={() =>
                          ...
                          className="flex items-center gap-4 p-4 hover:bg-blue-100/50 cursor-pointer rounded-lg border border-transparent hover:border-blue-200 transition-all group"
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-[10px] text-slate-500 mt-1">
                              128 GB free of 465 GB
                            </div>
                          </div>
                        </div>
                      </div>
                    ) : computerPath[computerPath.length - 1] ===
                      "Local Disk (C:)" ? (
                      <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-7 gap-x-2 gap-y-4">
                        {computerImages.map((img, idx) => (
                          <div
                            key={idx}
                            onDoubleClick={() => {
                              setSelectedImagePath(img.url);
                              focusWindow("imageView");
                              setWindows((prev) => ({
                                ...prev,
                                imageView: {
                                  ...prev.imageView,
                            ...
                            className="flex flex-col items-center p-2 rounded cursor-default group hover:bg-[#e5f3ff] hover:outline hover:outline-1 hover:outline-[#70c0ff]"
                          >
                            <div className="w-24 h-24 flex items-center justify-center bg-white border border-[#b8d6e9] shadow-[0_1px_3px_rgba(0,0,0,0.1)] p-1 mb-2 relative overflow-hidden">
                              <img
                                src={img.url}
                                alt={img.name}
                            ...
                            <span className="text-[11px] text-slate-900 text-center line-clamp-2 max-w-[90px] leading-tight font-sans">
                              {img.name}
                            </span>
                          </div>
                        ))}
                  ...
                  {/* Details Pane */}
                  <div className="h-11 border-t border-gray-300 bg-gradient-to-b from-[#eff2f7] to-[#d8e1ef] flex items-center px-4 gap-4 text-[11px] text-gray-700 shadow-[inset_0_1px_0_white]">
                    {computerPath[computerPath.length - 1] ===
                    "Local Disk (C:)" ? (
                      <>
                        <div className="w-10 h-10 flex items-center justify-center p-1 bg-white border border-gray-300 shadow-sm rounded-sm">
                      ...
                      <>
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-slate-600">
                            Local Disk (C:) Free Space: 128 GB Total Size: 465
                            GB
                          </span>
                        </div>
                      </>
              ...
              <OSWindow
                ...
                onMinimize={() => minimizeWindow("imageView")}
                onMaximize={() => toggleMaximize("imageView")}
                onFocus={() => focusWindow("imageView")}
              >
                <div className="flex-1 bg-white flex flex-col select-none font-sans overflow-hidden">
                  <div className="h-9 bg-[#f0f0f0] border-b border-gray-300 flex items-center px-4 gap-6 text-[11px] text-gray-700">
                    <div className="flex items-center gap-1 hover:bg-gray-200 px-2 py-1 rounded cursor-default border border-transparent hover:border-gray-300">
                  ...
                  <div className="flex-1 flex items-center justify-center p-8 bg-white overflow-hidden relative">
                    <div className="absolute inset-0 bg-gradient-to-b from-white to-[#e0e0e0] opacity-50 pointer-events-none" />
                    {selectedImagePath ? (
                      <img
                        src={selectedImagePath}
                        alt="Preview"
                        className="max-w-full max-h-full object-contain shadow-[0_10px_30px_rgba(0,0,0,0.15)] z-10 p-1 bg-white border border-gray-200"
                        referrerPolicy="no-referrer"
                      />
                    ) : (
                      <div className="text-gray-400 flex flex-col items-center gap-4 z-10">
                        <Image size={64} />
                        <span className="text-sm">Select a photo to view</span>
                      </div>
                    )}
                  </div>
                  <div className="h-20 bg-gradient-to-b from-[#f8f8f8] to-[#d8d8d8] flex items-center justify-center gap-4 border-t border-gray-300 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] relative">
                    <div className="flex items-center gap-2">
                      <button className="w-8 h-8 rounded-full flex items-center justify-center hover:bg-black/5 transition-colors border border-transparent hover:border-black/10">
                        <RotateCcw size={18} className="text-gray-600" />
                      </button>
                      <div className="flex items-center bg-[#f0f0f0] rounded-full p-1 border border-gray-300 shadow-sm">
                        <button
                          className="w-10 h-10 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors"
                          onClick={() => {
                            const currentIndex = computerImages.findIndex(
                              (img) => img.url === selectedImagePath,
                            );
                            const prevIndex =
                              (currentIndex - 1 + computerImages.length) %
                              computerImages.length;
                            setSelectedImagePath(computerImages[prevIndex].url);
                          }}
                        >
                          <ChevronLeft size={20} className="text-gray-700" />
                        </button>
                        <button className="w-14 h-14 rounded-full bg-blue-500 shadow-[0_2px_8px_rgba(59,130,246,0.5)] flex items-center justify-center text-white hover:bg-blue-600 transition-all active:scale-95 group">
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            const nextIndex =
                              (currentIndex + 1) % computerImages.length;
                            setSelectedImagePath(computerImages[nextIndex].url);
                          }}
                        >
              ...
              >
                <div className="flex-1 bg-white flex flex-col p-4 gap-4 overflow-y-auto font-sans">
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      {
                        name: "M.Taibe Portfolio",
                        url: "https://m-taibe.vercel.app/",
                      },
                      { name: "MG Design X", url: "https://mgdesignx.com/" },
                      {
                        name: "Motral Web Studio",
                        url: "https://motral-web-studio.vercel.app/",
                      },
                      {
                        name: "Techskoop",
                        url: "https://techskoop.vercel.app/",
                      },
                      {
                        name: "Bridal Saloon",
                        url: "https://bridal-saloon.vercel.app/",
                      },
                      {
                        name: "Pizza Hut Clone",
                        url: "https://pizza-hut-murex.vercel.app/",
                      },
                      {
                        name: "Motral Particles",
                        url: "https://motralparticles.vercel.app/",
                      },
                      {
                        name: "Ahad Portfolio",
                        url: "https://ahadportfolio-inky.vercel.app/",
                      },
                      {
                        name: "Ahmad Portfolio",
                        url: "https://ahmadprotfolio.vercel.app/",
                      },
                      { name: "Bizskoop", url: "https://bizskoop.vercel.app/" },
                      {
                        name: "Online Talismans",
                        url: "https://onlinetalismans.vercel.app/",
                      },
                      {
                        name: "Islamic Taweez",
                        url: "https://islamictaweez.vercel.app/",
                      },
                      {
                        name: "Rohani Ilaj Site",
                        url: "https://rohaniilajsite.vercel.app/",
                      },
                      {
                        name: "Quran Sy Ilaj",
                        url: "https://quransyilaj.vercel.app/",
                      },
                      {
                        name: "Online Istikhara Site",
                        url: "https://onlineistikharasite.vercel.app/",
                      },
                      {
                        name: "Free CV Maker",
                        url: "https://freecvmaker-motral.vercel.app/",
                      },
                      {
                        name: "MSF Portfolio",
                        url: "https://msf-five.vercel.app/",
                      },
                    ].map((proj, i) => (
                      <div
                        key={i}
                ...
                <div className="flex-1 bg-[#f0f0f0] flex flex-col items-center justify-center p-8 text-center italic text-slate-500 gap-4 font-sans">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">
                      This folder is password protected or encrypted.
                    </p>
                  </div>
                </div>
              </OSWindow>
                ...
                <div className="h-12 bg-slate-100 border-b border-slate-300 flex items-center px-2 gap-1 font-windows">
                  ...
                  >
                    <div className="relative">
                      <Trash2
                        size={20}
                        className="text-blue-600 group-hover:scale-105 transition-transform"
                      />
                    ...
                    <div className="grid grid-cols-4 gap-6">
                      {filteredRecycleFiles.map((file, idx) => (
                        <motion.div
                          ...
                          dragSnapToOrigin
                          onDragEnd={(e, info) =>
                            handleRecycleItemDragEnd(e, info, idx)
                          }
                        ...
                        >
                          {(file as any).component ? (
                            <div className="mb-2 group-hover:scale-105 transition-transform">
                              {React.createElement((file as any).component, {
                                size: 42,
                              })}
                            </div>
                          ) : (file as any).icon ? (
                ...
                <div className="flex-1 flex flex-col font-sans" ref={menuRef}>
                  <div className="h-7 bg-slate-50 border-b border-slate-200 flex items-center px-1 gap-0.5 select-none relative z-[50]">
                    {[
                      ...
                      },
                      {
                        ...
                        items: [
                          {
                            label: `Word Wrap: ${notepadWrap ? "On" : "Off"}`,
                            action: "wordWrap",
                          },
                      ...
                      {
                        label: "View",
                        items: [{ label: "Status Bar", action: "" }],
                      },
                      {
                        label: "Help",
                        items: [{ label: "About Notepad", action: "about" }],
                      },
                    ].map((menu) => (
                          ...
                          <div className="absolute top-full left-0 w-48 bg-[#f2f2f2] border border-[#979797] shadow-[2px_2px_3px_rgba(0,0,0,0.2)] py-1 z-[1000]">
                            {menu.items.map((item, i) =>
                              item.label === "Separator" ? (
                                <div
                                  key={i}
                                  className="my-1 border-t border-[#d7d7d7] mx-1"
                                />
                              ) : (
                                  ...
                                  <div
                                    onClick={() =>
                                      item.action === "fontMenu"
                                        ? null
                                        : handleNotepadAction(item.action)
                                    }
                  ...
                  <textarea
                    ...
                    onChange={(e) => {
                      ...
                      // Push to history
                      const newHistory = notepadHistory.slice(
                        0,
                        notepadHistoryIndex + 1,
                      );
                      newHistory.push(newText);
                    ...
                    style={{
                      ...
                      overflowX: notepadWrap ? "hidden" : "auto",
                    }}
                  />
                ...
                <div className="flex-1 flex flex-col bg-[#F0F0F0]">
                  <div className="h-6 bg-white border-b border-slate-200 flex items-center px-2 gap-4 text-[11px] text-slate-700 select-none">
                    <div className="group relative">
                      <span className="hover:bg-blue-100 px-2 py-0.5 cursor-default">
                        File
                      </span>
                      <div className="hidden group-hover:block absolute top-full left-0 w-32 bg-white shadow-md border border-slate-200 py-1 z-50">
                        <div
                          onClick={saveCanvas}
                          className="px-4 py-1 hover:bg-blue-600 hover:text-white flex items-center gap-2"
                        >
                          <Download size={12} />
                          Save As...
                        </div>
                    ...
                    {["Edit", "View", "Image", "Colors", "Help"].map((m) => (
                      <span
                        key={m}
                        className="hover:bg-blue-100 px-2 py-0.5 cursor-default"
                      >
                        {m}
                      </span>
                    ))}
                  ...
                  <div className="h-16 bg-[#F0F0F0] border-t border-slate-300 p-2 flex items-center gap-4">
                    <div className="flex items-center gap-2 border-r border-slate-300 pr-4">
                      <div
                        className="w-8 h-8 border-2 border-white shadow-inner"
              ...
              >
                ...
                >
                          ...
                          <div key={i} className="flex flex-col my-1">
                            {item.files.map((file: any, idx: number) => (
                              <motion.div
                                ...
                                dragSnapToOrigin
                                onDragEnd={(e, info) =>
                                  handleTerminalFileDragEnd(e, info, file.name)
                                }
                                whileDrag={{
                                  scale: 1.05,
                                  opacity: 0.8,
                  ...
                  <div className="flex items-center gap-1">
                    <span className="shrink-0 uppercase text-[#00FF00] font-bold">
                      C:\Users\M.Taibe&gt;
                    </span>
                    <input
                      id="terminal-input"
                    ...
                    {[
                      {
                        ...
                        desc: "Custom themes & Complex plugins",
                        icon: Globe,
                        color: "bg-[#21759b]",
                        level: "95%",
                      },
                      {
                        name: "Vibe coding",
                        desc: "AI-Assisted rapid development",
                        icon: Zap,
                        color: "bg-[#f1c40f]",
                        level: "92%",
                      },
                      {
                        ...
                        desc: "UI/UX & Modern architecture",
                        icon: Palette,
                        color: "bg-[#e67e22]",
                        level: "88%",
                      },
                      ...
                      <div
                        key={index}
                        className="bg-white border border-[#c9d9e5] rounded shadow-[0_1px_3px_rgba(0,0,0,0.1)] p-3 hover:bg-[#eaf1f7] transition-all group hover:border-[#a0c5e8] cursor-default"
                      >
                        <div className="flex items-center gap-3 mb-2">
                          <div
                            className={`p-2 rounded-md ${skill.color} text-white shadow-[inset_0_1px_2px_rgba(255,255,255,0.4)]`}
                          >
                            <skill.icon size={18} />
                          </div>
                ...
                <div className="flex-1 bg-[#f0f2f5] flex flex-col select-none font-sans overflow-hidden">
                  <div className="h-44 bg-gradient-to-br from-[#1a73e8] to-[#0d47a1] p-6 flex flex-col justify-end text-white relative overflow-hidden shrink-0">
                    ...
                    <div className="relative z-10 flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-medium bg-white/20 inline-block px-2 py-0.5 rounded-full mt-1 backdrop-blur-sm">
                  ...
                  <div className="flex-1 p-4 space-y-3 overflow-y-auto custom-scrollbar">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex items-center gap-4 p-3 bg-white hover:bg-green-50 rounded-xl cursor-pointer transition-all border border-slate-200 hover:shadow-lg hover:border-green-300 group"
                    >
                    ...
                    <a
                      ...
                      className="flex items-center gap-4 p-3 bg-white hover:bg-blue-50 rounded-xl cursor-pointer transition-all border border-slate-200 hover:shadow-lg hover:border-blue-300 group"
                    >
                    ...
                    <div className="mt-6 p-4 bg-slate-800 rounded-xl text-white shadow-xl relative overflow-hidden group">
                      <div className="relative z-10">
                        ...
                        <p className="text-[10px] opacity-70 mb-3 text-balance">
                          Need a professional website or graphic design? I'm
                          just a click away.
                        </p>
                      ...
                      <Sparkles
                        className="absolute -bottom-2 -right-2 opacity-5 scale-150 rotate-12"
                        size={80}
                      />
                    </div>
                    ...
                    <div className="pt-4 flex justify-center gap-3">
                      <div
                        onClick={() =>
                          window.open(
                            "https://github.com/taibejaved485-afk",
                            "_blank",
                          )
                        }
                        title="GitHub"
                        className="w-9 h-9 rounded-xl bg-white flex items-center justify-center text-slate-600 hover:bg-slate-900 hover:text-white cursor-pointer transition-all border border-slate-200 hover:border-slate-900 shadow-sm"
                      >
                        <Github size={18} />
                      </div>
                      <div
                        onClick={() =>
                          window.open(
                            "https://www.linkedin.com/in/taibe-javed-b28283396/",
                            "_blank",
                          )
                        }
                        title="LinkedIn"
                        className="w-9 h-9 rounded-xl bg-white flex items-center justify-center text-[#0077b5] hover:bg-[#0077b5] hover:text-white cursor-pointer transition-all border border-slate-200 hover:border-[#0077b5] shadow-sm"
                      >
                        <Linkedin size={18} />
                      </div>
                      <div
                        onClick={() =>
                          window.open(
                            "https://www.behance.net/Taibegraphics",
                            "_blank",
                          )
                        }
                        title="Behance"
                        className="w-9 h-9 rounded-xl bg-white flex items-center justify-center text-[#1769ff] hover:bg-[#1769ff] hover:text-white cursor-pointer transition-all border border-slate-200 hover:border-[#1769ff] shadow-sm"
                      >
                        <Palette size={18} />
                      </div>
                      <div
                        onClick={() =>
                          window.open("https://m-taibe.vercel.app/", "_blank")
                        }
                        title="Portfolio"
                        className="w-9 h-9 rounded-xl bg-white flex items-center justify-center text-purple-600 hover:bg-purple-600 hover:text-white cursor-pointer transition-all border border-slate-200 hover:border-purple-600 shadow-sm"
                      >
                        <Globe size={18} />
                      </div>
                    </div>
                    ...
                    >
                      <div className="h-8 bg-gradient-to-b from-blue-400 to-blue-600 flex items-center justify-between px-3">
                        ...
                        <div
                          ...
                          className="w-8 h-full flex items-center justify-center hover:bg-red-500 transition-colors cursor-pointer text-white"
                        >
                          <X size={14} />
                        </div>
                      </div>
                      <div className="bg-white p-6 space-y-4">
                        <div className="flex items-center gap-4">
                          <Win7Notepad size={48} />
                          <div>
                            <h2 className="text-xl font-semibold text-blue-600 italic">
                              Windows 7 Professional
                            </h2>
                            <p className="text-[11px] text-slate-500">
                              Copyright © 2026 M.Taibe. All rights reserved.
                            </p>
                          </div>
                        </div>
                        <div className="border-t border-slate-200 pt-4 text-[12px] text-slate-700 leading-relaxed">
                          <p>
                            The Notepad portfolio editing system is protected by
                            M.Taibe's dedication to high-fidelity UI design.
                          </p>
                          <p className="mt-2">
                            Developer:{" "}
                            <span className="font-semibold">M.Taibe</span>
                          </p>
              ...
              <AnimatePresence>
                {desktopContextMenu && (
                  ...
                  >
                      ...
                      {activeSubMenu === "view" && (
                        <div className="absolute left-full top-0 w-40 bg-[#f2f2f2] border border-[#a0a0a0] shadow-md py-1 text-gray-800 z-[10007]">
                          <div
                            ...
                            className="px-4 py-1.5 hover:bg-[#3299ff] hover:text-white flex items-center gap-2"
                          >
                            {iconSize === "large" && (
                    ...
                    <div className="px-4 py-1.5 hover:bg-[#3299ff] hover:text-white cursor-default opacity-50">
                      Paste
                    </div>
                    <div className="px-4 py-1.5 hover:bg-[#3299ff] hover:text-white cursor-default opacity-50 text-[11px]">
                      Paste shortcut
                    </div>
                    <div className="h-[1px] bg-[#d0d0d0] my-1 mx-1" />
                    <div
                      ...
                      {activeSubMenu === "new" && (
                        <div className="absolute left-full top-0 w-48 bg-[#f2f2f2] border border-[#a0a0a0] shadow-md py-1 text-gray-800 z-[10007]">
                          <div
                            ...
                            className="px-4 py-1.5 hover:bg-[#3299ff] hover:text-white"
                          >
                            Folder
                          </div>
                          <div
                    ...
                    >
                      ...
                      <div className="flex-1 flex overflow-hidden">
                        ...
                        <div className="w-48 bg-white/50 border-r border-slate-300 p-4 space-y-2">
                          <div className="text-[12px] text-blue-700 hover:underline cursor-pointer">
                            Control Panel Home
                          </div>
                          <div className="h-[1px] bg-slate-300 my-4" />
                          <div className="text-[12px] text-slate-800 font-medium bg-blue-100/50 p-1.5 rounded border border-blue-200">
                            Change desktop icons
                          </div>
                          <div className="text-[12px] text-slate-600 hover:underline cursor-pointer p-1.5">
                        ...
                        <div className="flex-1 bg-white p-6 overflow-y-auto">
                          <h2 className="text-lg text-blue-800 mb-4">
                            Change the visuals and sounds on your computer
                          </h2>

                          <div className="mb-8">
                            <h3 className="text-[13px] font-semibold text-slate-700 border-b border-slate-200 pb-1 mb-4">
                              Aero Themes
                            </h3>
                            <div className="grid grid-cols-4 gap-6">
                              {wallpapers.map((wp) => (
                ...
                {isResolutionOpen && (
                  <div className="fixed inset-0 flex items-center justify-center bg-black/20 z-[10006]">
                    <motion.div
                      ...
                      animate={{ opacity: 1, scale: 1 }}
                      exit={{ opacity: 0, scale: 0.95 }}
                      className="w-[600px] bg-[#f0f0f0] rounded border border-white shadow-2xl overflow-hidden flex flex-col font-sans"
                    >
                      <div className="h-8 aero-blur flex items-center justify-between px-3 border-b border-white/20 select-none">
                        <div className="flex items-center gap-2">
                      ...
                      <div className="flex-1 bg-white p-8 flex flex-col gap-8">
                        <div className="flex flex-col items-center gap-4">
                          <div className="w-48 h-32 bg-[#333] rounded-lg border-8 border-gray-400 shadow-xl flex items-center justify-center relative overflow-hidden">
                            <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-blue-400 to-blue-600 opacity-50" />
                          ...
                          <span className="text-[12px] text-slate-600 font-medium">
                            Display: 1. Generic PnP Monitor on Standard VGA
                            Graphics Adapter
                          </span>
                        </div>
                        ...
                        <div className="space-y-6">
                          <div className="grid grid-cols-[120px_1fr] items-center gap-4">
                            ...
                            <div className="h-6 border border-gray-300 bg-[#f9f9f9] px-2 flex items-center text-[12px] text-slate-800">
                          ...
                          <div className="grid grid-cols-[120px_1fr] items-center gap-4">
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              />
                              <span className="text-[12px] font-medium text-slate-800 min-w-[100px]">
                                1920 x 1080
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-[120px_1fr] items-center gap-4">
                            ...
                            <select className="h-6 border border-gray-300 bg-white px-1 text-[12px] text-slate-800 outline-none focus:border-blue-500">
                      ...
                      <div className="h-14 bg-[#f0f0f0] border-t border-slate-300 flex items-center justify-end px-6 gap-3">
                        ...
                        <button
                          disabled
                          className="px-8 py-1.5 bg-gray-100 border border-slate-200 rounded text-[12px] text-slate-400 opacity-50"
                        >
                          Apply
                        </button>
                      </div>
                ...
                {isGadgetsOpen && (
                  <div className="fixed inset-0 flex items-center justify-center bg-black/20 z-[10006]">
                    <motion.div
                      ...
                      animate={{ opacity: 1, scale: 1 }}
                      exit={{ opacity: 0, scale: 0.95 }}
                      className="w-[600px] h-[450px] bg-[#f0f0f0] rounded border border-white shadow-2xl overflow-hidden flex flex-col font-sans"
                    >
                      <div className="h-8 aero-blur flex items-center justify-between px-3 border-b border-white/20 select-none">
                        <div className="flex items-center gap-2">
                        ...
                        <div
                          onClick={() => setIsGadgetsOpen(false)}
                          className="w-10 h-full flex items-center justify-center hover:bg-[#e81123] hover:text-white transition-colors cursor-pointer"
                        >
                          <X size={16} />
                        </div>
                      ...
                      <div className="h-10 bg-white border-b border-slate-200 flex items-center px-4 justify-between">
                        <div className="flex items-center gap-4">
                          <div className="text-[11px] text-blue-700 hover:underline cursor-pointer">
                            Show details
                          </div>
                        </div>
                        <div className="relative">
                          <input
                            ...
                            className="w-40 h-6 border border-gray-300 px-2 pl-7 text-[11px] rounded-full outline-none focus:border-blue-400"
                          />
                          <Search
                            size={12}
                      ...
                      <div className="flex-1 bg-white p-6 overflow-y-auto font-sans">
                        <div className="grid grid-cols-4 gap-6">
                          {[
                            ...
                            <div
                              key={gadget.name}
                              className="flex flex-col items-center gap-2 p-3 hover:bg-blue-50 hover:outline hover:outline-1 hover:outline-blue-200 rounded cursor-pointer group transition-all"
                            >
                              <div className="w-16 h-16 bg-white border border-gray-200 rounded-lg shadow-sm flex items-center justify-center transform group-active:scale-95 transition-transform">
                                {React.cloneElement(
                                  gadget.icon as React.ReactElement,
                                  { size: 32 },
                                )}
                              </div>
                      ...
                      <div className="h-12 bg-[#f0f0f0] border-t border-slate-300 flex items-center justify-between px-6">
                        <div className="text-[10px] text-slate-500">
                          1/1 pages (7 gadgets)
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-6 h-6 flex items-center justify-center rounded border border-slate-300 bg-white opacity-40 text-gray-800">
                            <ChevronLeft size={14} />
                          </div>
                          <div className="w-6 h-6 flex items-center justify-center rounded border border-slate-300 bg-white opacity-40 text-gray-800">
                  ...
                  <div className="fixed inset-0 flex items-center justify-center bg-transparent z-[10002]">
                    ...
                    >
                      ...
                      <div className="p-4 bg-white space-y-4">
                        <div className="flex items-center gap-2">
                          <span className="text-[12px] text-[#333] w-20">
                            Find what:
                          </span>
                          <input
                            type="text"
                            ...
                            onChange={(e) =>
                              setNotepadSearchQuery(e.target.value)
                            }
                            onKeyDown={(e) =>
                              e.key === "Enter" && handleNotepadFindNext()
                            }
                        ...
                        {isReplaceMode && (
                          <div className="flex items-center gap-2">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setNotepadReplaceQuery(e.target.value)
                              }
                              onKeyDown={(e) =>
                                e.key === "Enter" && handleNotepadReplace()
                              }
                              className="flex-1 h-6 border border-[#adadad] px-2 text-[12px] outline-none focus:border-[#0078d7] text-gray-800 bg-white"
                            />
                          </div>
              ...
              <AnimatePresence>
                {isErrorOpen && (
                  <div className="fixed inset-0 flex items-center justify-center bg-black/10 z-[9999]">
                    ...
                    >
                      <div className="h-8 bg-white flex items-center justify-between px-3 border-b border-[#dadada]">
                        <span className="text-[12px] text-slate-700 font-medium font-sans">
                          Windows Error
                        </span>
                        <div
                      ...
                      <div className="p-6 flex items-start gap-5 bg-white">
                        ...
                        <p className="text-[13px] text-[#333] pt-2 leading-snug">
                          Access Denied. You are not ready for world domination
                          yet.
                        </p>
                      </div>
                  ...
                  <div className="fixed inset-0 flex items-center justify-center bg-black/5 z-[10001]">
                    ...
                    >
                      ...
                      <div className="bg-[#f0f0f0] p-4 flex justify-end gap-2">
                        ...
                        <button className="px-6 py-1 bg-white border border-[#adadad] rounded hover:border-[#0078d7] hover:bg-[#e5f1fb] text-[12px] transition-all font-medium opacity-50 cursor-not-allowed text-gray-800">
                          Browse...
                        </button>
                      </div>
                    </motion.div>
                      ...
                      <div className="p-6 flex items-start gap-5 bg-white">
                        ...
                        <div className="pt-1">
                          ...
                          <p className="text-[12px] text-slate-500">
                            This cannot be undone. You will lose access to world
                            domination plans (if any).
                          </p>
                        </div>
                      </div>
                      <div className="bg-[#f0f0f0] p-4 flex justify-end gap-2">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-10 aero-blur flex items-center justify-between px-1 z-[9000]">
              <div className="flex items-center h-full">
                ...
                <motion.div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle at 30% 30%, #5ba8ff 0%, #00459c 100%)",
                  }}
                >
                ...
                <AnimatePresence>
                  {isStartMenuOpen && (
                    <motion.div
                      ...
                      style={{
                        background:
                          "linear-gradient(to bottom, rgba(255,255,255,0.7) 0%, rgba(200,220,255,0.8) 100%)",
                        boxShadow:
                          "0 0 15px rgba(0,0,0,0.3), inset 0 0 2px rgba(255,255,255,0.5)",
                      }}
                    >
                          ...
                          {[
                            {
                              id: 1,
                              name: "My Computer",
                              component: Win7Computer,
                            },
                            {
                              id: 2,
                              name: "M.Taibe's Projects",
                              component: Win7Folder,
                            },
                            {
                              id: 3,
                              name: "Private Files",
                              component: (props: any) => (
                                <Win7Folder {...props} restricted />
                              ),
                            },
                            {
                              id: 4,
                              name: "My Resume",
                              component: Win7Document,
                            },
                            {
                              id: 5,
                              name: "M.Taibe's Skills",
                              component: (props: any) => (
                                <Win7Document {...props} variant="skills" />
                              ),
                            },
                            {
                              id: 6,
                              name: "Terminal",
                              component: Win7Terminal,
                            },
                            {
                              id: 7,
                              name: "Calculator",
                              component: Win7Calculator,
                            },
                            { id: 8, name: "Notepad", component: Win7Notepad },
                            { id: 9, name: "Paint", component: Win7Paint },
                            {
                              ...
                              name: "GitHub",
                              component: (props: any) => (
                                <Github {...props} className="text-gray-600" />
                              ),
                            },
                            {
                              id: 11,
                              name: "Contact M.Taibe",
                              component: Win7Phone,
                            },
                          ].map((app) => (
                            <div
                            ...
                            >
                              ...
                              <span className="text-[12px] text-gray-800 font-[400] font-sans">
                                {app.name}
                              </span>
                            </div>
                          ))}
                            ...
                            {searchTerm && (
                              <div className="absolute left-0 bottom-full w-full bg-white border border-gray-300 rounded-t shadow-lg py-1 z-50">
                                ...
                                {filteredStartApps.length === 0 && (
                                  <div className="px-3 py-1.5 text-gray-400 text-[11px] italic">
                                    No results
                                  </div>
                                )}
                              </div>
                      ...
                      <div
                        className="w-[40%] flex flex-col pt-4"
                        style={{
                          background:
                            "linear-gradient(to right, rgba(200,225,255,0.6), rgba(150,180,250,0.6))",
                        }}
                      >
                        {/* Profile Section */}
                        <div className="flex flex-col items-center mb-4 px-4">
                          ...
                          <span className="text-xs font-bold text-white drop-shadow-sm tracking-tight">
                            M.Taibe
                          </span>
                        </div>
                  ...
                  onClick={() => {
                    setWindows((prev) => {
                      ...
                      Object.keys(next).forEach(
                        (k) => (next[k] = { ...next[k], isMinimized: true }),
                      );
                      return next;
                    });
                  }}
